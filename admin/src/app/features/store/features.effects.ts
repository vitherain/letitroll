...
export class FeaturesEffects {
  constructor(private actions$: Actions, private httpClient: HttpClient, private store: Store<FeaturesState>) {}
  ...
  features$ = this.actions$
    ...
    .switchMap((action: FeatureActions.ApiGetFeatures) => {
      ...
      return this.httpClient.get<FeaturesState>('/api/v1/projects/5acfba0a85c2500f4007b6eb/features', { params });
    })
    .map((features: FeaturesState) => {
      return {
